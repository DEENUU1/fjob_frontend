                    ...
                    {isAuthenticated ? (
                        <>
                          ...
                          {user?.account_type == "USER" ? (
                            <DropdownMenu>
                              <DropdownMenuTrigger
                                className="w-full px-6 py-2 mt-3 text-center lg:ml-5">Profile</DropdownMenuTrigger>
                              <DropdownMenuContent>
                                <DropdownMenuItem>
                                  <Link href="/dashboard">
                                    Dashboard
                      ...
                      : (
                        <>
                          <Link href="/auth/login"
                                className="w-full px-6 py-2 mt-3 text-center lg:ml-5 bg-blue-400 hover:bg-blue-500 rounded-md ">
                            Get Started
                          </Link>
                          <Link href="/auth/register/company"
                                className="w-full px-6 py-2 mt-3 text-center bg-purple-400 hover:bg-purple-500 rounded-md lg:ml-5">
                            Post offer
                          </Link>
                        </>
                      )
        ...
        <div className="hidden text-center lg:flex lg:items-center">
          <ul className="items-center justify-end flex-1 pt-6 list-none lg:pt-0 lg:flex">
            <li className="mr-3 nav__item">
              <Link href="/"
                    className="inline-block px-4 py-2 text-lg font-normal text-black no-underline rounded-md  hover:text-gray-700">
                Home
              </Link>
              <Link href="/offer"
                    className="inline-block px-4 py-2 text-lg font-normal text-black no-underline rounded-md  hover:text-gray-700">
        ...
        <div className="hidden mr-3 space-x-4 lg:flex nav__item">
          {isAuthenticated ? (
            ...
            : (
              <>
                <Link href="/auth/login"
                      className="px-6 py-2 text-black bg-blue-400 hover:bg-blue-500 rounded-md md:ml-5">
                  Get Started
                </Link>
                <Link href="/auth/register/company"
                      className="px-6 py-2 text-black bg-purple-400 hover:bg-purple-500 rounded-md md:ml-5">
                  Post offer
                </Link>
              </>
            )
