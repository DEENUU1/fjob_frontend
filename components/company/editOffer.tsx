...
export default function EditOfferModal({offer}) {
    ...
    const handleSubmit = async (e: any) => {
        ...
        try {
            const response = await fetch(`${getApiUrl()}api/offer/company/${offer.id}/`, {
                method: "PUT",
                headers: {
            ...
            {showModal ? (
                ...
                >
                    ...
                    <form onSubmit={handleSubmit}>
                            ...
                            <button type="submit" className=" mt-2 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Update</button>
                            <button
